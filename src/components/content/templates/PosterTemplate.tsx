  ...
  return (
    ...
    >
      <div className="w-full max-w-md flex items-center justify-between pb-3 mb-6" style={{ borderBottom: '1px solid #f2f2f3' }}>
        <span className="text-[10px] font-medium" style={{ color: '#979799', fontFamily: bodyFontFamily }}>Steep — Poster Preview</span>
      ...
      <div
        ...
        className="w-full max-w-md text-white text-left relative overflow-hidden flex flex-col justify-between min-h-[460px] aspect-[3/4]"
      >
        ...
        <div className="flex items-center justify-between z-10">
          <div className="flex items-center gap-1.5 bg-white/15 backdrop-blur-xs px-3 py-1 text-[9px] font-medium uppercase tracking-widest rounded-[9999px]" style={{ fontFamily: bodyFontFamily }}>
            <Sparkles className="w-3 h-3 text-[#fbe1d1]" />
            <span>ANNUAL CONFERENCE 2026</span>
          </div>
          <span className="text-[10px] font-medium animate-pulse" style={{ color: '#fbe1d1', fontFamily: bodyFontFamily }}>LIVE</span>
        </div>

        <div className="flex flex-col gap-4 my-8 z-10">
          <h2
            style={{ ...headingStyle, fontSize: '44px', lineHeight: 1.3, letterSpacing: '-0.66px' }}
            className="leading-tight"
          >
            STEEP & <span style={{ color: '#fbe1d1' }}>INNOVATION</span> SYMPOSIUM
          </h2>
          <p style={{ fontSize: '15px', lineHeight: 1.5 }} className="text-white/80 max-w-[280px] leading-relaxed font-normal">
        ...
        <div className="flex flex-col gap-4 pt-4 z-10" style={{ borderTop: '1px solid rgba(255,255,255,0.1)' }}>
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-[9px] text-white/50 font-medium uppercase" style={{ fontFamily: bodyFontFamily }}>Date</span>
                <span style={{ fontSize: '12px', fontFamily: bodyFontFamily, fontWeight: 400 }}>17 November 2026</span>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <MapPin className="w-4 h-4 text-white/70" />
              <div className="flex flex-col">
                <span className="text-[9px] text-white/50 font-medium uppercase" style={{ fontFamily: bodyFontFamily }}>Venue</span>
                <span style={{ fontSize: '12px', fontFamily: bodyFontFamily, fontWeight: 400 }}>Symphony Hall, Jakarta</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pt-1">
            <button
              ...
              style={{ backgroundColor: '#ffffff', color: c1, borderRadius: '9999px', padding: '14px 20px', fontSize: '16px', fontWeight: 400, fontFamily: bodyFontFamily }}
              type="button"
              className="cursor-pointer border-none"
            >
              Get Free Tickets
            </button>
            <div style={{ borderRadius: '9999px', fontFamily: bodyFontFamily }} className="flex items-center gap-1.5 bg-white/15 px-3 py-2 text-[9px] font-medium">
